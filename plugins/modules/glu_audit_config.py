...
DOCUMENTATION = '''
    ...
    description:
        ...
        - This module supports specifying the friendl#!/usr/bin/python
# -*- coding: utf-8 -*-
...
y name of the device if the organization name is specified as well instead of supplying the device_id parameter.  
        Note: If an error of 'HTTP Error 400: Bad Request' is displayed then possibly the playbook task is trying to set a
    version_added: '2.8'
    author:
        - John Anderson
