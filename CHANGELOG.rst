...
Minor Changes
-------------
- Updated documentation formatting to avoid unnecessary comments in examples
- Updated glu_capture_config module to view the proper work status output
...
Minor Changes
-------------
- Fixed issue where non System Developer role in Gluware was unable to query the devices in Device Manager for inventory
...
- Updated README.md to contain Support, Release Notes, and Roadmpa section.
